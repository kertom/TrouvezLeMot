...
const index$1 = require('./index-48bc365e.js');
const cubicBezier = require('./cubic-bezier-16d7da31.js');
const frameworkDelegate = require('./framework-delegate-461e4328.js');
const index$2 = require('./index-bc39a44d.js');
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!ionicGlobal.config.getBoolean('_testing')) {
          Promise.resolve().then(function () { return require('./tap-click-84291e2a.js'); }).then((module) => module.startTapClick(ionicGlobal.config));
        }
        if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
          Promise.resolve().then(function () { return require('./status-tap-8c9c72e3.js'); }).then((module) => module.startStatusTap());
        }
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          Promise.resolve().then(function () { return require('./input-shims-4406686e.js'); }).then((module) => module.startInputShims(ionicGlobal.config));
        }
        ...
        if (typeof window !== 'undefined') {
          Promise.resolve().then(function () { return require('./keyboard-7652d3a7.js'); }).then((module) => module.startKeyboardAssist(window));
        }
        Promise.resolve().then(function () { return require('./focus-visible-13f6b222.js'); }).then((module) => (this.focusVisible = module.startFocusVisible()));
      });
    }
  }
  /**
