...
const index$2 = require('./index-e9d456ae.js');
...
const index$3 = require('./index-039e2aea.js');
const overlays = require('./overlays-230845e4.js');
const theme = require('./theme-e6fec71e.js');
const index$4 = require('./index-bc39a44d.js');
const animation = require('./animation-0b06daf1.js');
...
const Modal = class {
  ...
  render() {
    ...
    return (index$2.h(index$2.Host, Object.assign({ "no-router": true, "aria-modal": "true", tabindex: "-1" }, htmlAttributes, { style: {
      ...
      }, class: Object.assign({ [mode]: true, ['modal-default']: !isCardModal && !isSheetModal, [`modal-card`]: isCardModal, [`modal-sheet`]: isSheetModal, 'overlay-hidden': true }, theme.getClassMap(this.cssClass)), id: modalId, onIonBackdropTap: this.onBackdropTap, onIonModalDidPresent: this.onLifecycle, onIonModalWillPresent: this.onLifecycle, onIonModalWillDismiss: this.onLifecycle, onIonModalDidDismiss: this.onLifecycle }), index$2.h("ion-backdrop", { ref: (el) => (this.backdropEl = el), visible: this.showBackdrop, tappable: this.backdropDismiss, part: "backdrop" }), mode === 'ios' && index$2.h("div", { class: "modal-shadow" }), index$2.h("div", { role: "dialog", class: "modal-wrapper ion-overlay-wrapper", part: "content", ref: (el) => (this.wrapperEl = el) }, showHandle && index$2.h("div", { class: "modal-handle", part: "handle" }), index$2.h("slot", null))));
  }
